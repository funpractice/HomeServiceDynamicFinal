  ...
  return (
    <div id="contact" className="block contactBlock">
      <div className="quickSupport">
          ...
          <Button className="buton"  type="primary" size="large" href="mailto:wecarehomecare.2511@gmail.com"><MdEmail style={{marginRight:"4px", marginBottom:"2px"}} /> Email Us</Button>
